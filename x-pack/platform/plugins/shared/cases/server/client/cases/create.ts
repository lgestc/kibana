  ...
  try {
    ...
    await userActionService.creator.createUserAction({
      userAction: {
        ...
        payload: {
          ...queryWithMappings,
          severity: queryWithMappings.severity ?? CaseSeverity.LOW,
          assignees: queryWithMappings.assignees ?? [],
          category: queryWithMappings.category ?? null,
          customFields: queryWithMappings.customFields ?? [],
        },
